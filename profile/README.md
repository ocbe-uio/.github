...
- **First-time contributors:** Some repositories have a contribute page (accessible via the repository's "Contribute" button or `/contribute` path) listing issues that are ideal for first-time contributors
